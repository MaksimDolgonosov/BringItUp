...
window.addEventListener("DOMContentLoaded", function () {
  ...
  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_5__["default"](".plus__content", ".msg").init();
...
function () {
  ...
  _createClass(Download, [{
    key: "downloadPic",
    value: function downloadPic(link) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function controlEmailInputs() {
      this.emailInputs.forEach(function (textInput) {
    ...
    key: "bindPostData",
    value: function bindPostData(form) {
      var _this = this;
      ...
      form.querySelector(".btn").addEventListener("click", function (e) {
        ...
        if (form.querySelector(".policy")) {
          form.querySelector(".policy").innerHTML = _this.loading;
        } else {
          statusMessage.textContent = _this.loading;
        ...
        _this.postData("assets/question.php", formData).then(function (data) {
          ...
          if (form.querySelector(".policy")) {
            form.querySelector(".policy").innerHTML = _this.failure;
          } else {
            form.lastElementChild.remove();
            statusMessage.textContent = _this.failure;
            form.append(statusMessage);
          }
        }).finally(function () {
          if (form.querySelector(".policy")) {
            form.querySelector(".policy").innerHTML = _this.success;

            _this.clearInputs();

            setTimeout(function () {
              return form.querySelector(".policy").innerHTML = 'By clicking «Send» I am agreed <br> with Privacy Policy.';
            }, 2000);
          } else {
            form.lastElementChild.remove();
            statusMessage.textContent = _this.success;
            form.append(statusMessage);

            _this.clearInputs();

            setTimeout(function () {
              return form.lastElementChild.remove();
            }, 2000);
          }
        });
      });
...
function () {
  function VideoPlayer(triggers, overlay) {
    ...
    this.onPlayerStateChange = this.onPlayerStateChange.bind(this); //console.log(this.btns);
  }
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function createPlayer(url) {
      ...
      this.overlay.style.display = "flex"; //console.log(this.player);
    }
  }, {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ShowInformation; });
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.define-property */ "./node_modules/core-js/modules/es.object.define-property.js");
/* harmony import */ var core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_1__);
...
/*#__PURE__*/
function () {
  function ShowInformation(plusBtn, msg) {
  ...
  _createClass(ShowInformation, [{
    ...
    value: function bindTriggers() {
      ...
      this.plusBtn.forEach(function (btn, i) {
        btn.addEventListener("click", function () {
          // btn.closest(".module__info-show").nextElementSibling.style.display = "block";
          if (_this.msg[i].style.display == "block") {
            _this.msg[i].classList.add("fadeInUp");

            _this.msg[i].classList.remove("fadeInDown");

            _this.msg[i].style.display = "none";
          } else {
            _this.msg[i].classList.remove("fadeInUp");

            _this.msg[i].classList.add("fadeInDown");

            _this.msg[i].style.cssText = "   \n                margin-top: 15px;\n                font-weight: 400;\n                line-height: 20px;\n                font-size: 14px;\n                letter-spacing: -.26px;\n                padding-bottom: -10";
            _this.msg[i].style.display = "block";
          }
        });
      });
    }
...
function (_Slider) {
  ...
  function MiniSlaider(page, next, slides, prev, activeClass, animate, autoplay) {
    _classCallCheck(this, MiniSlaider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlaider).call(this, page, slides, next, prev, activeClass, animate, autoplay));
  }

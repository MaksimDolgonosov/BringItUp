...
function (_Slider) {
  ...
  function MiniSlaider(page, next, prev) {
    _classCallCheck(this, MiniSlaider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlaider).call(this, page, next, prev));
  }
